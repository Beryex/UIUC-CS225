...
TEST_CASE("test_unbalanced", "[weight=10]"){
  ...
  //REQUIRE(tree.kthSmallest(1) == 0);
  //REQUIRE(tree.kthSmallest(1) == 10);
  REQUIRE(tree.kthSmallest(1) == 10);
  REQUIRE(tree.kthSmallest(2) == 35);
  REQUIRE(tree.kthSmallest(3) == 40);
  REQUIRE(tree.kthSmallest(4) == 58);
  REQUIRE(tree.kthSmallest(5) == 61);
  REQUIRE(tree.kthSmallest(6) == 72);
  REQUIRE(tree.kthSmallest(7) == 80);
  REQUIRE(tree.kthSmallest(8) == 93);
  REQUIRE(tree.kthSmallest(9) == 95);
}
