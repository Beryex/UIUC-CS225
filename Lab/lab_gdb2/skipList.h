...
class SkipList 
{
    public:
         ...
         * @param Pr The probability of increasing the height of a node
         * @param Mlevel The maximum allowable height of the skiplist
         */
        SkipList(int Pr, int Mlevel);

        /**
         * Constructs the SkipList with one initial node, which is constructed with the provided values.
         * 
         * @param key1 The key to associate with the initial node
         * @param value1 The pixel to associate with the initial node
         */
        SkipList(int key1, HSLAPixel value1);
         ...
         * @param key1 The key to associate with the initial node
         * @param value1 The pixel to associate with the initial node
         * @param probability1 The probability of increasing the height of a node
         * @param maxlevel1 The maximum allowable height of the skiplist

         */
        SkipList(int key1, HSLAPixel value1, int probability1, int maxlevel1);
