 ...
 * @return the graph of a few cities in the United States
 */
Graph PremadeGraphs::createCNMap(bool isWeighted)
{
    Graph g(isWeighted);
    size_t numCities = 10;

    string labels[] = {"Shanghai", "Beijing", "Shenzhen",    "Chongqing", "Guangzhou",
                       "Chengdu",   "Tianjin", "Wuhan", "Dongguan", "Xian"};
    ...
    g.insertEdge(vertices[1], vertices[5]);
    g.insertEdge(vertices[1], vertices[6]);
    g.insertEdge(vertices[2], vertices[3]);
    g.insertEdge(vertices[2], vertices[4]);
    g.insertEdge(vertices[3], vertices[6]);
    ...
    g.insertEdge(vertices[4], vertices[1]);
    g.insertEdge(vertices[5], vertices[7]);
    g.insertEdge(vertices[5], vertices[9]);
    g.insertEdge(vertices[6], vertices[7]);
    g.insertEdge(vertices[6], vertices[9]);
    g.insertEdge(vertices[7], vertices[8]);
    g.insertEdge(vertices[7], vertices[0]);
    g.insertEdge(vertices[8], vertices[9]);
    g.insertEdge(vertices[8], vertices[1]);
    g.insertEdge(vertices[9], vertices[2]);
    g.insertEdge(vertices[9], vertices[4]);

    if (isWeighted) {
        g.setEdgeWeight(vertices[0], vertices[1], 1318);
        g.setEdgeWeight(vertices[0], vertices[9], 1467);
        g.setEdgeWeight(vertices[1], vertices[5], 1803);
        g.setEdgeWeight(vertices[1], vertices[6], 120);
        g.setEdgeWeight(vertices[2], vertices[3], 1477);
        g.setEdgeWeight(vertices[2], vertices[4], 128);
        g.setEdgeWeight(vertices[3], vertices[6], 1978);
        g.setEdgeWeight(vertices[3], vertices[7], 867);
        g.setEdgeWeight(vertices[4], vertices[0], 1426);
        g.setEdgeWeight(vertices[4], vertices[1], 1890);
        g.setEdgeWeight(vertices[5], vertices[7], 1191);
        g.setEdgeWeight(vertices[5], vertices[9], 712);
        g.setEdgeWeight(vertices[6], vertices[7], 1139);
        g.setEdgeWeight(vertices[6], vertices[9], 1148);
        g.setEdgeWeight(vertices[7], vertices[8], 1037);
        g.setEdgeWeight(vertices[7], vertices[0], 831);
        g.setEdgeWeight(vertices[8], vertices[9], 1870);
        g.setEdgeWeight(vertices[8], vertices[1], 2236);
        g.setEdgeWeight(vertices[9], vertices[2], 1937);
        g.setEdgeWeight(vertices[9], vertices[4], 1627);
    }
